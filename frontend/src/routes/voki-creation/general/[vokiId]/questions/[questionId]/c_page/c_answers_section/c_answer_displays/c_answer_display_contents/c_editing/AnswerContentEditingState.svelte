<script lang="ts">
	...
	import ColorOnlyAnswerEditing from './c_contents/ColorOnlyAnswerEditing.svelte';
	import ImageAndTextAnswerEditing from './c_contents/ImageAndTextAnswerEditing.svelte';
