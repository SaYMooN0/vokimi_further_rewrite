<script lang="ts">
	import AlbumsBlockedSignInRequiredDIalog from './c_albums_blocked/AlbumsBlockedSignInRequiredDIalog.svelte';

	let signInRequiredDialog = $state<AlbumsBlockedSignInRequiredDIalog>()!;
</script>

<button class="album-blocked-btn" onclick={() => signInRequiredDialog.open()}>
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
		<path d="M12 16.5V14.5" stroke="currentColor" stroke-linecap="round" />
		<path
...
<AlbumsBlockedSignInRequiredDIalog bind:this={signInRequiredDialog} />
