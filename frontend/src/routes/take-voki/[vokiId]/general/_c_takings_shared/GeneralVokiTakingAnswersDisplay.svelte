<script lang="ts">
	...
	import GeneralVokiTakingColorAndTextAnswer from './_c_answers_display/GeneralVokiTakingColorAndTextAnswer.svelte';
	import GeneralVokiTakingColorOnlyAnswer from './_c_answers_display/GeneralVokiTakingColorOnlyAnswer.svelte';
	import GeneralVokiTakingImageAndTextAnswer from './_c_answers_display/GeneralVokiTakingImageAndTextAnswer.svelte';
	import GeneralVokiTakingImageOnlyAnswer from './_c_answers_display/GeneralVokiTakingImageOnlyAnswer.svelte';
