<script lang="ts">
	...
	let seeAnywayPressed = $state(false);
	let showVokiNotTaken = $derived(!(hasUserTaken || seeAnywayPressed));
	...
	<div class="wrap" role="region" aria-label="Spoiler warning">
		<div class="content">
			...
			<div class="actions">
				...
				<button class="secondary" type="button" onclick={() => (seeAnywayPressed = true)}>
					See anyway
				</button>
			</div>
		</div>
